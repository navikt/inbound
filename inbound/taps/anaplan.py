...
class AnaplanTap(Tap):
    ...
    def __init__(self, workspaceID, modelID, exportID, fileID, username, password):
        ...
        self.base_url = f"https://api.anaplan.com/2/0/workspaces/{workspaceID}/models/{modelID}"
    ...
    def data_generator(self) -> Generator[list[tuple], Any, None]:
        ...
        for chunk in chunks:
            ...
            # TODO: Isoler IO
            file = self._get_exported_file_chunk(
            ...
            with bytes_to_file as f:
                reader = csv.reader(f)
                # TODO: usikker om dette må gjøres på alle chunks, eller bare første
