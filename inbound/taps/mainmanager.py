...
class MainManagerTap(Tap):
    ...
    def __init__(self, table: str, username: str, password: str):
        self.table = table
        self.username = username
        self.password = password
        self.base_url = os.environ["MAINMANAGER_URL"]
        self.endpoint = f"/api/v1/datawarehouseview?viewname={table}&datatableoutput=4)"

    def column_descriptions(self) -> list[Description]:
        return [Description(name="raw", type="variant", precision=None, scale=None, nullable=True)]
